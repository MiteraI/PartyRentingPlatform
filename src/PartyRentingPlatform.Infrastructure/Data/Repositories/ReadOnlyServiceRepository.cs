...
{
    public class ReadOnlyServiceRepository : ReadOnlyGenericRepository<Service, long?>, IReadOnlyServiceRepository
    {
        public ReadOnlyServiceRepository(IUnitOfWork context) : base(context)
        {
        }
    }
}
