...
using PartyRentingPlatform.Security;
...
using AuthenticationService = PartyRentingPlatform.Domain.Services.AuthenticationService;
using IAuthenticationService = PartyRentingPlatform.Domain.Services.Interfaces.IAuthenticationService;
