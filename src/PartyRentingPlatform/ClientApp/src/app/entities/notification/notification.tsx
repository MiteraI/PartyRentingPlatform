            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('sentTime')}>
                  Sent Time <FontAwesomeIcon icon={getSortIconByFieldName('sentTime')} />
                </th>
                <th className="hand" onClick={sort('enum')}>
                  Enum <FontAwesomeIcon icon={getSortIconByFieldName('enum')} />
                </th>
                <th>
            ...
            <tbody>
              {notificationList.map((notification, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {notification.sentTime ? <TextFormat type="date" value={notification.sentTime} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>{notification.enum}</td>
