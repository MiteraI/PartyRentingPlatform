          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('roomName')}>
                  Room Name <FontAwesomeIcon icon={getSortIconByFieldName('roomName')} />
                </th>
                ...
                <th className="hand" onClick={sort('roomCapacity')}>
                  Room Capacity <FontAwesomeIcon icon={getSortIconByFieldName('roomCapacity')} />
                </th>
