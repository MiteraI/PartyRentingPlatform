...
import { getEntity, deleteEntity } from './room-image.reducer';
...
export const RoomImageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="partyRentingPlatformApp.roomImage.delete.question">
        Are you sure you want to delete Room Image {roomImageEntity.id}?
      </ModalBody>
      <ModalFooter>
