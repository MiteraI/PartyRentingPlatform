            ...
            <tbody>
              {reportList.map((report, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{report.sentTime ? <TextFormat type="date" value={report.sentTime} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{report.room ? <Link to={`/room/${report.room.id}`}>{report.room.id}</Link> : ''}</td>
