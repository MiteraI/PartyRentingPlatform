...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKINGDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOKINGDETAILS actions', async () => {
      const expectedActions = [
        {
