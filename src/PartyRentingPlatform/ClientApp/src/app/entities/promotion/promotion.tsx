            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('minimum')}>
                  Minimum <FontAwesomeIcon icon={getSortIconByFieldName('minimum')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {promotionList.map((promotion, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{promotion.startTime ? <TextFormat type="date" value={promotion.startTime} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{promotion.endTime ? <TextFormat type="date" value={promotion.endTime} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{promotion.discount}</td>
                  <td>{promotion.minimum}</td>
